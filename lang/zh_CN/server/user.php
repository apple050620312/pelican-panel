...
return [
    ...
    'permissions' => [
        ...
        'startup_title' => '启动',
        'startup_desc' => '控制用户查看此服务器启动参数能力的权限。',

        'settings_title' => '设置',
        'settings_desc' => '控制用户修改此服务器设置能力的权限。',

        'control_title' => '控制',
        'control_desc' => '控制用户控制服务器电源状态或发送命令能力的权限。',

        'user_title' => '用户',
        'user_desc' => '允许用户管理服务器上其他子用户的权限。他们将永远无法编辑自己的帐户，或分配他们自己没有的权限。',

        'file_title' => '文件',
        'file_desc' => '控制用户修改此服务器文件系统能力的权限。',

        'allocation_title' => '分配',
        'allocation_desc' => '控制用户修改此服务器端口分配能力的权限。',

        'database_title' => '数据库',
        'database_desc' => '控制用户访问此服务器数据库管理能力的权限。',

        'backup_title' => '备份',
        'backup_desc' => '控制用户生成和管理服务器备份能力的权限。',

        'schedule_title' => '计划任务',
        'schedule_desc' => '控制用户访问此服务器计划任务管理能力的权限。',
