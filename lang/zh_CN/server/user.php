...
return [
    ...
    'permissions' => [
        ...
        'user_title' => '用户',
        'user_desc' => '允许用户管理服务器上其他子用户的权限。他们永远无法编辑自己的帐户，也无法分配自己没有的权限。',
        'file_title' => '文件',
        'file_desc' => '控制用户修改此服务器文件系统的能力的权限。',
        'allocation_title' => '分配',
        'allocation_desc' => '控制用户修改此服务器端口分配的能力的权限。',
        'database_title' => '数据库',
        'database_desc' => '控制用户访问此服务器数据库管理的权限。',
        'backup_title' => '备份',
        'backup_desc' => '控制用户生成和管理服务器备份的能力的权限。',
        'schedule_title' => '计划任务',
        'schedule_desc' => '控制用户访问此服务器计划任务管理的权限。',
        'startup_read' => '允许用户查看服务器的启动变量。',
        'startup_update' => '允许用户修改服务器的启动变量。',
        'startup_docker_image' => '允许用户修改运行服务器时使用的 Docker 映像。',
        ...
        'user_read' => '允许用户查看与此服务器关联的用户的权限。',
        'user_update' => '允许用户修改与此服务器关联的其他用户。',
        'user_delete' => '允许用户删除与此服务器关联的其他用户。',
        'file_create' => '允许用户创建新文件和目录的权限。',
        'file_read' => '允许用户查看目录的内容，但不允许查看文件的内容或下载文件。',
        'file_read_content' => '允许用户查看给定文件的内容。这也将允许用户下载文件。',
        'file_update' => '允许用户更新与服务器关联的文件和文件夹。',
        'file_delete' => '允许用户删除文件和目录。',
        'file_archive' => '允许用户创建文件压缩包并解压现有的压缩包。',
        'file_sftp' => '允许用户使用 SFTP 客户端执行上述文件操作。',
        'allocation_read' => '允许用户查看当前分配给此服务器的所有分配。对此服务器具有任何级别访问权限的用户始终可以查看主要分配。',
        'allocation_update' => '允许用户更改主要服务器分配并为每个分配附加备注。',
        'allocation_delete' => '允许用户从服务器删除分配。',
        'allocation_create' => '允许用户将其他分配分配给服务器。',
        'database_create' => '允许用户为服务器创建新数据库的权限。',
        'database_read' => '允许用户查看服务器数据库的权限。',
        'database_update' => '允许用户对数据库进行修改的权限。如果用户也没有“查看密码”的权限，他们将无法修改密码。',
        'database_delete' => '允许用户删除数据库实例的权限。',
        'database_view_password' => '允许用户在系统中查看数据库密码的权限。',
        'schedule_create' => '允许用户为服务器创建新计划任务。',
        'schedule_read' => '允许用户查看服务器计划任务的权限。',
        'schedule_update' => '允许用户对现有服务器计划任务进行修改的权限。',
        ...
        'backup_restore' => '允许用户恢复服务器的备份。危险：这允许用户在此过程中删除服务器的所有文件。',
        'mount_desc' => '控制用户管理此服务器挂载的能力的权限。',
        'mount_read' => '允许用户查看挂载页面并查看可用的挂载。',
        'mount_update' => '允许用户打开或关闭服务器的挂载。',
    ],
];
