...
return [
    ...
    'actions' => [
        ...
        'move' => [
            ...
            'notification' => '文件已移动',
            'bulk_notification' => '将 :count 个文件移动到了 :directory',
        ],
        'permissions' => [
            'title' => '权限',
            'read' => '读取',
        ...
        'delete' => [
            'notification' => '文件已删除',
            'bulk_notification' => '已删除 :count 个文件',
        ],
        'edit' => [
            'title' => '正在编辑： :file',
            'save_close' => '保存并关闭',
    ...
    'alerts' => [
        ...
        'pelicanignore' => [
            ...
            'body' => '此处列出的任何文件或目录都将被从备份中排除。支持使用星号 (<code>*</code>) 的通配符。<br>您可以在前面加上感叹号 (<code>!</code>) 来否定先前的规则。',
        ],
    ],
];
